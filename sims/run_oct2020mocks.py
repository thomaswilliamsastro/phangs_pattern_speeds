# -*- coding: utf-8 -*-
"""
Run on the streaming motion mocks
...
from vars import phangs_folder, plot_folder, output_folder, slit_widths, slit_lengths, plot
...
if not os.path.exists(plot_folder + mock_names):
    os.mkdir(plot_folder + mock_names)
if not os.path.exists(output_folder + mock_names):
    os.mkdir(output_folder + mock_names)
    ...
    for bar_ellip in bar_ellips:
        ...
        for bar_len in bar_lens:
            ...
            for f in fs:
                ...
                hdu_name = mock_names + '/BarDW3ModelSM7__1_' + bar_len + '_' + bar_ellip + '_' + bar_ang + '_' + f

                try:
                    flux_hdu = fits.open(hdu_name + '_brightI.fits')[0]
                ...
                file_name += bar_len + '_' + bar_ellip + '_' + bar_ang + '_' + f
                ...
                flux = flux_hdu.data
                vel = fits.open(hdu_name + '_modelI.fits')[0].data
                ...
                if plot and n_pattern_speeds == 1:
                    ...
                    bootstrap_tw(flux, flux_err, vel, vel_err, grid_step=grid_step,
