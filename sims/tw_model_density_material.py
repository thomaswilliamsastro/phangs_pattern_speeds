# -*- coding: utf-8 -*-
"""
Test run on density spiral versus material spiral
...
if not os.path.exists(plot_folder + 'density_material'):
    os.mkdir(plot_folder + 'density_material')
if not os.path.exists(output_folder + 'density_material'):
    os.mkdir(output_folder + 'density_material')

bar_lens = ['115.0', '130.0', '150.0']
bar_lens = ['115.0', '130.0']
bar_ellips = ['0.25', '0.5']
bar_angs = ['5.0', '15.0', '30.0', '45.0', '60.0', '90.0', '120.0', '150.0', '180.0', '210.0']
density_waves = [False, True]
...
for density_wave in density_waves:
                ...
                for slit_width in slit_widths:
                    ...
                    for slit_length in slit_lengths:
                        ...
                        for covering_factor in covering_factors:
                            ...
                            hdu_name += 'ngc4303' + bar_len + bar_ellip + bar_ang + 'Bar'
